...
var functions = {
    addNew : function(req,res) {
        if((!req.body.name) || (!req.body.password) || (!req.body.email) || (!req.body.username) || (!req.body.telephone)|| (!req.body.city) || (!req.body.adress) || (!req.body.postalCode)){
    ...
    authenticate: function(req,res){
        Particulier.findOne({
            ...
            if(!particulier) {
                ...
                particulier.comparePassword(req.body.password, function(err,isMatch){
                    if(isMatch && !err) {
