...
class RegisterSelectionPage extends StatefulWidget {
  const RegisterSelectionPage({Key? key, required String title}) : super(key: key);
          ...
          children: <Widget>[
            Column(
                children: <Widget>[
                  ...
                  const Padding(padding:EdgeInsets.only(top: 80) ,child: Text("Je m'inscrit en tant que :", style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),)),
                  Container(
